...
class PribadiController extends Controller
{
    ...
    {
        $pribadi = Pribadi::orderBy('id_pribadi', 'asc')->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pribadi.index')->with('success','Data Berhasil Disimpan');
    ...
    {
        $pribadi->delete();
        return redirect()->route('pribadi.index')->with('success','Data Berhasil Dihapus');
    }
}
