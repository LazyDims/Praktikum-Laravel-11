...
class ProgdiController extends Controller
{
     ...
     */
    public function show(Progdi $id)
    {
        //
    }
    ...
    public function update(Request $request, Progdi $progdi)
    {
        ...
        return redirect()->route('progdi.index')->with('success','Data Berhasil Diperbarui');
    }
    ...
    {
        $progdi->delete();
        return redirect()->route('progdi.index')->with('success','Data Berhasil Dihapus');
    }
}
